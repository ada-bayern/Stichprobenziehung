...
tibble(
  ...
  `Größe der Grundgesamtheit` = params$data_size,
...
if (params$proportional) {
  note <- "Die gewählten Stichprobenanteile sind proportional zu den Anteilen in der Grundgesamtheit."
} else {
  note <- "Die gewählten Stichprobenanteile sind NICHT proportional zu den Anteilen in der Grundgesamtheit."
}
tibble(Note = note)
```
```{r echo=FALSE}
