...
MANUAL <- list(
  ...
  "sample" = c(
    ...
    "Einstellung Auswahlwahrscheinlichkeit:\nBei sehr kleinen Wahrscheinlichkeiten kann es zu Rundungsfehlern kommen, die ungewollte Effekte bei der Stichprobenziehung haben können. In diesem Fall sollten Sie auf die Einstellung Stichprobenanteil wechseln.",
