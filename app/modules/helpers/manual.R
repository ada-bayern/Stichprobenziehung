...
MANUAL <- list(
  ...
  "sample" = c(
    ...
    "Hier können Sie den einstellen, welche Garantie Sie bei der Stichprobenziehung haben wollen: Garantierte Kategorienanteile, garantierte Stichprobengröße oder keine Garantie. Es kann manchmal sein, dass eine bestimmte Garantie nicht zu einem Ergebnis führen kann.",
